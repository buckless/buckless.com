<template>
  <b-part class="flow" :contentPadding="0" full>
...
.timeline .year div ul:last-child {
    margin-bottom: 0;
}

.timeline .year div ul li {
    margin-left: .5rem;
}

.timeline .year div ul:first-of-type:after {
    content: '';
    width: 10px;
    height: 10px;
    background: #c5c5c5;
